package com.drizzlepal.springboot2.webstarter;
...
@ComponentScans({ @ComponentScan("com.drizzlepal.springboot2.webstarter"),
        @ComponentScan("com.drizzlepal.springboot.webstarter") })
public class WebStarterConfig implements WebMvcConfigurer {

    public WebStarterConfig() {
        log.info("加载 Drizzlepal Web Starter2 自动配置");
    }
